         ...
         <div class="col-md-5">
             ...
             <form method="POST" action="{{ route('mypage') }}">
                 ...
                 <div class="form-group">
                     ...
                     <div class="collapse show editUserPhone">
                         <input id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ $user->address }}" required autocomplete="address" autofocus placeholder="XX県○○ X-X-X">
                         @error('address')
                         <span class="invalid-feedback" role="alert">
                 ...
                 <hr>
                 <button type="submit" class="btn btn-info position-absolute bottom-30 start-50">
                     保存
                 </button>
             </form>
         </div>
